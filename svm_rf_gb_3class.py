...
ntrains = [0.3, 0.4, 0.5, 0.6, 0.7, 0.8]
seeds = range(10)
savefig = 0
savemodel = 0
...
# Unstable, low-kinetic stable: Label -1
# How-kinetic stable: Label 0
# Stable: Label 1
ml_onehot_data.loc[ml_onehot_data['Stability']==0,'Stability']=-1
ml_onehot_data.loc[ml_onehot_data['Stability']==1,'Stability']=-1
ml_onehot_data.loc[ml_onehot_data['Stability']==2,'Stability']=0
...
dimRedu_fnames = ['svmLinear-3class']
...
for dimRedu_fname in dimRedu_fnames:
	...
	for ntrain in ntrains:
		for rnseed in seeds:
			...
			# Random Forest MODEL
			###################						
			param_grid = {"n_estimators": range(40,100,5), "max_features": range(3,10)}
